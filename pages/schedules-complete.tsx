    ...
    <Fragment>
      ...
      <Page
        ...
        title={
          <Fragment>
            <h1>
              Pagamento Efetuado<small>Confira os detalhes do pedido</small>
            </h1>
          </Fragment>
        }
      ...
      >
        ...
        <p>
          {format(new Date(data.scheduleAt), "d 'de' MMMM 'de' yyyy", {
            locale,
          })}
        </p>
        <p>
          Número do Pedido: {String(data.id).padStart(6, '0')}
