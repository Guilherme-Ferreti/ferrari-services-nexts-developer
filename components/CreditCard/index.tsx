...
const CreditCard = (props: CreditCardProps) => {
  ...
  return (
    <div className={['faces', flipped && 'flipped'].join(' ')} id="credit-card">
      <svg
        className="front"
        xmlns="http://www.w3.org/2000/svg"
        width="397.843"
        height="246.639"
        viewBox="0 0 397.843 246.639"
      >
      ...
      >
        <g transform="translate(-4292.083 3734.497)">
          ...
          <text
            transform="translate(4230 -3617)"
            fill="#333"
            fontSize="22"
            fontFamily="NothingYouCouldDo, Nothing You Could Do"
          >
            <tspan
              x="89.566"
              y="21"
